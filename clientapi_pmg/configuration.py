...
AuthSettings = TypedDict(
    "AuthSettings",
    {
        "PMGAuthCookie": APIKeyAuthSetting,
        "CSRFPreventionToken": APIKeyAuthSetting,
        "PMGApiToken": APIKeyAuthSetting,
    },
    total=False,
)
...
conf = clientapi_pmg.Configuration(
    ...
    def __init__(
        ...
        *,
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("clientapi_pmg")
    ...
    def auth_settings(self)-> AuthSettings:
        ...
        """
        auth: AuthSettings = {}
        if 'PMGAuthCookie' in self.api_key:
            auth['PMGAuthCookie'] = {
                'type': 'api_key',
                'in': 'cookie',
                'key': 'PMGAuthCookie',
        ...
        if 'PMGApiToken' in self.api_key:
            auth['PMGApiToken'] = {
                'type': 'api_key',
                'in': 'header',
                'key': 'Authorization',
