...
from clientapi_pmg.api_response import ApiResponse, T as ApiResponseT
import clientapi_pmg.models
from clientapi_pmg import rest
from clientapi_pmg.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(clientapi_pmg.models, klass)
