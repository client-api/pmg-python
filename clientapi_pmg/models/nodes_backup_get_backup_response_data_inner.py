...
class NodesBackupGetBackupResponseDataInner(BaseModel):
    """
    ...
    def filename_validate_regular_expression(cls, value):
        ...
        if not re.match(r"pmg-backup_[0-9A-Za-z_-]+\.tgz", value):
            raise ValueError(r"must validate the regular expression /pmg-backup_[0-9A-Za-z_-]+\.tgz/")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NodesBackupGetBackupResponseDataInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NodesBackupGetBackupResponseDataInner from a dict"""
        if obj is None:
            return None
