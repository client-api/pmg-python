...
class QuarantineListattachmentsResponse(BaseModel):
    """
    QuarantineListattachmentsResponse
    """ # noqa: E501

    data: List[QuarantineListattachmentsResponseDataInner]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of QuarantineListattachmentsResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of QuarantineListattachmentsResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "data": [QuarantineListattachmentsResponseDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "total": obj.get("total"),
