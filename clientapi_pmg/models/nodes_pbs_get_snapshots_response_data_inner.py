...
class NodesPbsGetSnapshotsResponseDataInner(BaseModel):
    """
    NodesPbsGetSnapshotsResponseDataInner
    """ # noqa: E501

    backup_id: StrictStr = Field(alias="backup-id")

    backup_time: StrictStr = Field(alias="backup-time")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NodesPbsGetSnapshotsResponseDataInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NodesPbsGetSnapshotsResponseDataInner from a dict"""
        if obj is None:
            return None
