...
class ConfigRuledbEmailRequest(BaseModel):
    """
    ConfigRuledbEmailRequest
    """ # noqa: E501

    email: Annotated[str, Field(strict=True)] = Field(description="Email address.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ConfigRuledbEmailRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ConfigRuledbEmailRequest from a dict"""
        if obj is None:
            return None
