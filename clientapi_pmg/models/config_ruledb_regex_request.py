...
class ConfigRuledbRegexRequest(BaseModel):
    """
    ConfigRuledbRegexRequest
    """ # noqa: E501

    regex: Annotated[str, Field(strict=True, max_length=1024)] = Field(description="Email address regular expression.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ConfigRuledbRegexRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ConfigRuledbRegexRequest from a dict"""
        if obj is None:
            return None
