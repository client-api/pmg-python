...
class ConfigCustomscoresGetScoreResponseData(BaseModel):
    """
    ConfigCustomscoresGetScoreResponseData
    """ # noqa: E501

    comment: Optional[StrictStr] = Field(default=None, description="The Comment.")
    ...
    __properties: ClassVar[List[str]] = ["comment", "name", "score"]
    ...
    def name_validate_regular_expression(cls, value):
        ...
        if not re.match(r"[a-zA-Z\_\-\.0-9]+", value):
            raise ValueError(r"must validate the regular expression /[a-zA-Z\_\-\.0-9]+/")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ConfigCustomscoresGetScoreResponseData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ConfigCustomscoresGetScoreResponseData from a dict"""
        if obj is None:
            return None
