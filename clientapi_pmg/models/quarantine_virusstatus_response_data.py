...
class QuarantineVirusstatusResponseData(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["avgbytes", "count", "mbytes"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of QuarantineVirusstatusResponseData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of QuarantineVirusstatusResponseData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "avgbytes": obj.get("avgbytes"),
            "count": obj.get("count"),
            "mbytes": obj.get("mbytes")
        })
        return _obj
