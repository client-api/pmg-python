...
class VersionVersionResponseData(BaseModel):
    ...
    release: StrictStr = Field(description="The current installed Proxmox Mailgateway Release")

    repoid: StrictStr = Field(description="The short git commit hash ID from which this version was build")

    version: StrictStr = Field(description="The current installed pmg-api package version")
