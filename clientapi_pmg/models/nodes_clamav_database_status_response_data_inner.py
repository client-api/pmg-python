...
class NodesClamavDatabaseStatusResponseDataInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["build_time", "nsigs", "type", "version"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NodesClamavDatabaseStatusResponseDataInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NodesClamavDatabaseStatusResponseDataInner from a dict"""
        if obj is None:
            return None
