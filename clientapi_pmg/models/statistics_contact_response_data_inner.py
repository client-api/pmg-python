...
class StatisticsContactResponseDataInner(BaseModel):
    """
    ...
    contact: StrictStr = Field(description="Contact email.")
    ...
    __properties: ClassVar[List[str]] = ["bytes", "contact", "count", "viruscount"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StatisticsContactResponseDataInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StatisticsContactResponseDataInner from a dict"""
        if obj is None:
            return None
