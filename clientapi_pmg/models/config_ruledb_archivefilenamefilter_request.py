...
class ConfigRuledbArchivefilenamefilterRequest(BaseModel):
    """
    ConfigRuledbArchivefilenamefilterRequest
    """ # noqa: E501

    filename: Annotated[str, Field(strict=True, max_length=1024)] = Field(description="Filename filter")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ConfigRuledbArchivefilenamefilterRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ConfigRuledbArchivefilenamefilterRequest from a dict"""
        if obj is None:
            return None
